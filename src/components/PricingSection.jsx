        ...
        <div className="max-w-xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col items-center mb-6">
              <span className="text-2xl text-white/60 line-through">{plan.originalPrice}</span>
              <span className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">
                {plan.price}
              </span>
              <span className="text-green-400 text-sm mt-2 font-medium">
                Oferta válida hasta {plan.offerValidUntil}
              </span>
            </div>
