    ...
    <section id='pricingSection' className="py-20 px-4 md:py-32 md:px-8 bg-black/90 relative overflow-hidden">
      <div className="container mx-auto max-w-4xl relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          Diseñada para empresas que quieren destacar online con un sitio profesional, moderno y funcional.

          </p>
        </div>

        <div className="max-w-xl max-h-xl mx-auto">
          <div 
          ...
          >
            ...
            <p className="text-white/80 mb-8 text-lg">{plan.description}</p>
            ...
            <a href="#contacto">
              <button className="w-full py-4 px-6 border border-opacity-10 border-white bg-white text-black rounded-md hover:from-white/5 hover:to-white/10 transform transition-all duration-300 font-semibold text-lg shadow-lg">
                Reservar Ahora
              </button>
            </a>
          </div>
